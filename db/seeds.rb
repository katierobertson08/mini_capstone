...
product = Product.new({name: "Rescue Dog of the Month Coffee Mug", price: 35, description: "Put the Rescue Dog of the Month from a local animal rescue on this custom coffee cup", image_url: "to be added"})
product.save

product = Product.new({name: "Resuce Cat of the Month Coffee Cup", price: 35, description: "Put the Rescue Cat of the Month from a local animal rescue on this custom coffee cup", image_url: "to be added"})
product.save
